      ...
      <div class="hero-description-wrapper">
        <div class="squiggle-arrow">
          <svg width="80" height="150" viewBox="0 0 100 150" fill="none" xmlns="http://www.w3.org/2000/svg">
            <!-- Complex loop path -->
            <path d="M45 20 C 75 15, 95 40, 80 70 C 65 100, 30 80, 35 60 C 40 40, 65 55, 65 75 C 65 95, 30 110, 60 130"
              stroke="white" stroke-width="2.5" stroke-linecap="round" fill="none" />
            <!-- Paper Plane -->
            <g transform="translate(60, 130) rotate(15)">
              <path d="M0 0 L 25 10 L 0 20 L 5 10 Z" stroke="white" stroke-width="2" stroke-linejoin="round"
                fill="none" />
              <path d="M5 10 L 15 15" stroke="white" stroke-width="2" stroke-linecap="round" />
            </g>
          </svg>
        </div>
        <p class="hero-subtitle">We specialize in trekking adventures and uncovering the untouched beauty of Sri Lanka's
    ...
    <div class="container">
      <div class="grid grid-2 align-center gap-lg">
        <div class="about-content reveal">
          ...
          <p class="text-body">Sri Lanka is a land of breathtaking landscapes from lush mountains and misty forests to
            golden beaches and hidden waterfalls. With rich biodiversity, vibrant culture, and scenic trails, it's a
            true paradise for adventure seekers.</p>
          <p class="text-body">At The Ceylon Trek, we specialize in trekking tours that go beyond the ordinary. More
            than just guided walks, we explore with you as friends—sharing stories, local insights, and unforgettable
            moments.</p>

          <ul class="check-list">
            <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <polyline points="20 6 9 17 4 12"></polyline>
              </svg> 2+ Years of Experience</li>
            <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <polyline points="20 6 9 17 4 12"></polyline>
              </svg> Affordable Prices & Premium Quality</li>
            <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <polyline points="20 6 9 17 4 12"></polyline>
              </svg> Friendly & Responsive Communication</li>
            <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <polyline points="20 6 9 17 4 12"></polyline>
              </svg> Expert Guides with Extensive Knowledge</li>
          </ul>

          <div class="mt-4">
            <a href="<?php echo URLROOT; ?>/contact" class="btn btn-outline">Book Now</a>
          </div>
        </div>
        ...
        <div class="about-image-wrapper reveal delay-1">
          <div class="image-grid">
            <img
              src="https://www.lankatrek.com/wp-content/uploads/2025/06/IMG_20190713_171741-scaled-1-e1749206869615.webp"
              alt="Sri The Ceylon Trekking Experience" class="img-large rounded-lg shadow-lg" />
            <img
              src="https://www.lankatrek.com/wp-content/uploads/2025/06/WhatsApp-Image-2025-04-17-at-5.16.21-PM-1-scaled.webp"
              alt="Hiking in Sri Lanka" class="img-small rounded-lg shadow-md" />
  ...
  <section class="section services bg-light" id="services">
    <div class="container">
      <div class="section-header text-center reveal">
        ...
        <p class="section-description">Get up close with nature as you trek through Sri Lanka's most stunning
          landscapes. Join us for unforgettable journeys through mountains and forests.</p>
      </div>
      ...
      <div class="grid grid-4 gap-md mt-5">
        <div class="service-card reveal">
          ...
          <p class="service-desc">Choose from over 16 scenic trails. Perfect for travelers short on time but big on
            exploration.</p>
        </div>
        ...
        <div class="service-card reveal delay-1">
          ...
          <p class="service-desc">Immerse yourself in breathtaking landscapes on unique trekking routes spanning
            multiple days.</p>
        </div>
        ...
        <div class="service-card reveal delay-2">
          ...
          <p class="service-desc">Experience the thrill of camping in wild beauty. Sleep under the stars and wake up to
            nature.</p>
        </div>
    ...
    <div class="container">
      <div class="grid grid-2 align-center gap-xl">
        <div class="assistance-content reveal">
          ...
          <p class="text-body text-white-70">We ensure your comfort, safety, and needs are top priorities across every
            trek. From transportation to high-quality camping gear, The Ceylon Trek provides an all-inclusive experience
            so you can focus purely on the journey.</p>

          <div class="assist-features mt-4">
            <div class="assist-item">
              <div class="assist-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                  stroke-width="2">
        ...
        <div class="assistance-image-wrapper reveal delay-1">
          <div class="glass-card">
            <img src="https://www.lankatrek.com/wp-content/uploads/2023/02/IMG_8620-scaled-e1749211652491.webp"
              alt="Trekking Assistance" class="rounded-lg shadow-lg w-full" />
    ...
    <div class="container">
      <div class="cta-box reveal">
        ...
        <div class="cta-action">
          <a href="https://wa.me/94777562425" class="btn btn-white btn-lg" target="_blank" rel="noopener noreferrer">
